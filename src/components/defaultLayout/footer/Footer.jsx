    ...
    return(
        <footer>
            ...
            <div className="social-links">
                    <ul>
                        <li>
                            <a href="https://github.com/LevaTiger" target='_blank'>
                        ...
                        <li>
                            <a href="https://www.linkedin.com/in/levente-bogn%C3%A1r-32a67226a/" target='_blank'>
            ...
            <div className="copyright">
                <small>Készítette: Bognár Levente 2025 ©
                </small>
            </div>
        </footer>
    )
